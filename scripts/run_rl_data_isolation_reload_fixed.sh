...
SESSION_NAME="${RL_DATA_ISOLATION_TMUX_SESSION:-rl_data_isolation_reload_fixed_20260801}"
...
if [[ "$MODE" == "--dry-run" ]]; then
  echo "RL data-isolation reload-fixed dry run: native v2 manifests, GRPO/CISPO seeds 42,43,44, max 32 steps"
