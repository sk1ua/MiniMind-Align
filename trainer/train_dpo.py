...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_steps", type=int, default=0, help="最多优化步数，0表示不限制")
    ...
    parser.add_argument("--model_dir", type=str, default="out", help="基础权重目录")
    parser.add_argument("--checkpoint_dir", type=str, default="checkpoints", help="resume checkpoint目录")
    ...
    # 初始化参考模型（ref_model冻结）
    ref_model, _ = init_model(lm_config, args.from_weight, tokenizer_path=args.tokenizer_path, save_dir=args.model_dir, device=args.device)
    ref_model.eval()
